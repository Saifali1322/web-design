...
export const metadata: Metadata = {
  ...
  description:
    "Full allergen matrix for every Juice Cartel product, covering all 14 UK-regulated allergens. Made in a kitchen that also handles milk, wheat, soya and nuts — contact us before ordering if you have a severe allergy.",
};
...
export default function AllergensPage() {
  return (
    <div className="bg-grain">
      <section className="mx-auto max-w-4xl px-5 pb-8 pt-14 sm:px-8 sm:pt-20">
      ...
      >
        ...
        <p className="max-w-2xl text-sm leading-relaxed text-cream-dim">
          Please talk to us before you order rather than after. Message{" "}
          <a
            href={SOCIALS.instagram}
            target="_blank"
            rel="noopener noreferrer"
