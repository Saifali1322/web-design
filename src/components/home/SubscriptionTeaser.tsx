        ...
        <div className="grid gap-12 lg:grid-cols-[0.85fr_1.15fr] lg:gap-16">
          ...
          <Reveal>
            ...
            <p className="mt-6 max-w-md text-[0.9375rem] leading-relaxed font-light text-cream-dim">
              ...
              {DELIVERY.dropDay} for less than buying it bottle by bottle. Swap
              what&rsquo;s in it any week. Cancel it in two taps.
            </p>

            <ul className="mt-7 space-y-3">
              {[
                "Cheaper than ordering one-off",
                `Free delivery across ${DELIVERY.city}`,
                "Change flavours before Thursday",
